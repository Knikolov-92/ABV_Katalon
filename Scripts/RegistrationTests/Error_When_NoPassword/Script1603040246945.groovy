...
WebUI.clearText(findTestObject('RegistrationPage/inputPassword'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('RegistrationPage/errorMessage'), 'Моля попълнете полето Парола.')
