...
WebUI.clearText(findTestObject('RegistrationPage/inputPhoneNumber'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('RegistrationPage/errorMessage'), 'Моля попълнете полето Телефон.')
