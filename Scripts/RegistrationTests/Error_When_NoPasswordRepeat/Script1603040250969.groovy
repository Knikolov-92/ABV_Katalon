...
WebUI.clearText(findTestObject('RegistrationPage/inputPasswordRepeat'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('RegistrationPage/errorMessage'), 'Моля попълнете полето Повтори парола.')
