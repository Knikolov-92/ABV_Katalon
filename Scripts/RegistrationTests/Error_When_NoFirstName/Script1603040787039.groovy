...
WebUI.clearText(findTestObject('RegistrationPage/inputFirstName'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('RegistrationPage/errorMessage'), 'Моля попълнете полето Име.')
