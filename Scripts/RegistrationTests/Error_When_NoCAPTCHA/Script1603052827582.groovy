...
WebUI.setText(findTestObject('RegistrationPage/inputFirstName'), 'aaa')

WebUI.setText(findTestObject('RegistrationPage/inputLastName'), 'bbb')

WebUI.check(findTestObject('RegistrationPage/radioButtonMale'))

WebUI.selectOptionByIndex(findTestObject('RegistrationPage/dropdownBday'), 2)

WebUI.selectOptionByIndex(findTestObject('RegistrationPage/dropdownBmonth'), 5)

WebUI.selectOptionByIndex(findTestObject('RegistrationPage/dropdownByear'), 10)
...
WebUI.verifyElementText(findTestObject('RegistrationPage/errorMessage'), 'Моля попълнете полето Антиспам верификация.')
